...
sed -i '' 's|LIBCXXDIR3="usr/include/c++/v1"|LIBCXXDIR3="Library/Developer/CommandLineTools/SDKs/MacOSX14.4.sdk/usr/include/c++/v1"|' osxcross/tools/gen_sdk_package.sh
