...
FROM golang:$GOLANG_VERSION-alpine3.18
...
RUN curl -sfLo /osxcross/tarballs/MacOSX12.3.sdk.tar.xz https://github.com/bdwyertech/dkr-crosscompile/releases/download/macsdk/MacOSX12.3.sdk.tar.xz \
    ...
    && rm -f /osxcross/tarballs/MacOSX12.3.sdk.tar.xz \
    && apk del .build-deps
